        ...
        <Card>
            <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                    <div>
                        <CardTitle className="text-lg">{t('reports.topExpenses.title')}</CardTitle>
                        <p className="text-sm text-muted-foreground">
                            {t('reports.topExpenses.subtitle')}
                        </p>
                    </div>
                    {!isLoading && transactions.length > 0 && (
                        <div className="text-right">
                            <p className="text-sm text-muted-foreground">{t('reports.topExpenses.topTotal', { count: transactions.length })}</p>
