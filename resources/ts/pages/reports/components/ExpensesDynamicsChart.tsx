...
export function ExpensesDynamicsChart({ filters }: ExpensesDynamicsChartProps) {
    ...
    }, [data, enabledCategories, groupBy, t, i18n.language])
        ...
        <Card>
            <CardHeader className="pb-2">
                <div className="flex items-start justify-between">
                    <div>
                        <CardTitle className="text-lg">{t('reports.expensesDynamics.title')}</CardTitle>
                        <p className="text-sm text-muted-foreground">
                            {t('reports.expensesDynamics.subtitle')}
                        </p>
                    </div>
