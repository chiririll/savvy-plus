...
return [
    ...
    'transactions' => [
        'not_pending' => 'Подтвердить можно только отложенную транзакцию.',
        'cannot_skip' => 'Пропустить можно только отложенную транзакцию из расписания.',
        'cannot_delete_recurring' => 'Вхождение из расписания нельзя удалить. Пропустите или подтвердите его.',
        'cannot_edit_recurring' => 'Вхождение из расписания нельзя изменить. Измените шаблон повторения.',
        'cannot_duplicate_recurring' => 'Вхождение из расписания нельзя дублировать.',
        'cannot_duplicate' => 'Эту транзакцию нельзя дублировать.',
        'cannot_edit_skipped' => 'Пропущенную транзакцию нельзя изменить.',
        'date_required' => 'Для подтверждённой транзакции нужна дата.',
        'date_required_to_confirm' => 'Укажите дату, чтобы подтвердить транзакцию.',
        'date_cannot_be_future' => 'Подтверждённая транзакция не может быть с датой в будущем.',
    ],
    ...
    'backup' => [
        ...
        'invalid' => 'Этот файл не является корректной резервной копией SQLite.',
        'missing' => 'Файл резервной копии не найден.',
        'newer' => 'Эту копию нельзя восстановить: она от более новой версии приложения.',
    ],
    ...
    'import' => [
        ...
        'date_in_future' => 'Импортированная транзакция не может быть с датой в будущем.',
